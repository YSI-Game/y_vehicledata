...
[![sampctl](https://shields.southcla.ws/badge/sampctl-y_vehicledata-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Game/y_vehicledata)
...
```bash
sampctl package install YSI-Game/y_vehicledata
```

Include in your code and begin using the library:

```pawn
#include <YSI-Game/y_vehicledata>
```

## Documentation

* [Quick Start](YSI-Game/y_vehicledata/quick-start.md) - One very simple example of getting started with this library.
* [Features](YSI-Game/y_vehicledata/features.md) - More features and examples.
* [FAQs](YSI-Game/y_vehicledata/faqs.md) - Frequently Asked Questions, including errors and solutions.
* [API](YSI-Game/y_vehicledata/api.md) - Full list of all functions and their meaning.
* [Internal](YSI-Game/y_vehicledata/internal.md) - Internal developer documentation for the system.
